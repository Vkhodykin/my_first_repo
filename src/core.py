    ...
    while is_working:
        ...
        if user_input == constants.INFO_COMMAND:
            ...
            while create_a_new_entry:
                ...
                if input_type_transaction == "income":
                ...
                elif input_type_transaction == "expense":

                    expense_amount = True
                    while expense_amount:

                        display.show_info_message("Введите сумму расхода:")
                        input_amount = input(">> ")
                    ...
                    while expense_category:
                        ...
                        display.show_info_message("Введите категорию расходов (Mandatory/Optional/Saving):")
                        category_input = input(">> ")

                        if blu.validate_category(category_input, 'expense'):
                            break


                    expense_description = True
                    while expense_description:

                        display.show_info_message("Введите описание расходов (не более 255 символов):")
                        description_type = input(">> ")
                    ...
                    write_operation = blu.try_add_journal_entry_expense(gen_total,
                                                                        gen_expense,
                                                                        input_type_transaction,
                                                                        input_amount,
                                                                        category_input,
